...
public class NewJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Студентський квиток");

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Студентський квиток"));
        ...
        jLabel4.setText("спеціальність");

        jLabel5.setText("роки навчання");

        jLabel6.setText("По-батькові");

        jTextField1.setText("Дребезов");
        ...
        jTextField3.setText("Олегович");

        jTextField4.setText("6.1217-1");

        jTextField5.setText("Програмна інженерія");

        jTextField6.setText("2017-2021");
        ...
        jButton1.setText("Моя автобиография");
